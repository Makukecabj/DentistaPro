  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-24 left-6 z-40 w-14 h-14 rounded-full bg-ink text-paper shadow-elevated flex items-center justify-center hover:shadow-glow-teal transition-shadow duration-300"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-40 left-6 z-40 w-[340px] max-w-[calc(100vw-3rem)] rounded-2xl border border-ink/8 bg-white shadow-elevated overflow-hidden flex flex-col"
          >
            {/* Header */}
