        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <a
              ...
              className="rounded-full border border-paper/25 text-paper px-8 py-5 text-[15px] font-medium hover:border-paper/50 hover:bg-white/10 transition-all duration-300 flex items-center gap-2"
            >
