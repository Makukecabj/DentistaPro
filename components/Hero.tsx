  ...
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-paper">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-paper/50 via-paper/30 to-paper/10" />
        <div className="absolute inset-0 bg-gradient-to-t from-paper/40 via-transparent to-paper/10" />
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-5 sm:px-6 pt-28 pb-20 w-full">
        <div className="max-w-2xl">
          ...
          <motion.h1
            ...
            className="font-display text-[2.5rem] md:text-[4rem] font-medium leading-[1.05] mb-6 tracking-tight text-ink"
          >
            Tu sonrisa merece
            <br />
          ...
          <motion.p
            ...
            className="text-ink/75 text-lg md:text-xl mb-10 max-w-lg leading-relaxed"
          >
          ...
          >
            <a
              href="#contacto"
              className="group relative rounded-full bg-gold px-8 py-4 sm:py-5 text-[15px] font-semibold text-ink transition-all duration-300 hover:bg-gold-dark hover:text-paper hover:shadow-glow-lg hover:scale-[1.03] active:scale-[0.97] focus-visible:ring-2 focus-visible:ring-gold-light focus-visible:ring-offset-2 focus-visible:ring-offset-paper overflow-hidden w-full sm:w-auto text-center"
            >
            ...
            <a
              ...
              className="rounded-full border border-ink/25 text-ink px-8 py-4 sm:py-5 text-[15px] font-medium hover:border-ink/50 hover:bg-ink/10 transition-all duration-300 flex items-center justify-center gap-2 w-full sm:w-auto text-center"
            >
          ...
          >
            {TRUST_ITEMS.map((item) => (
              <div key={item.text} className="flex items-center gap-2 text-[13px] text-ink/60">
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center gap-4 text-[13px] text-ink/50"
          >
