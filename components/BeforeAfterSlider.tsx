...
const FALLBACK_CASES: BeforeAfterCase[] = [
  ...
  { id: "f4", clinic_id: "", before_url: "/images/blog/limpieza.webp", after_url: "/images/blog/limpieza.webp", title: "Limpieza", description: "Dientes libres de placa y tartaro", order: 4 },
];
...
export default function BeforeAfterSlider() {
  ...
  // Si antes y después son la misma URL, se muestra una sola foto fija (sin slider)
  const currentCaseData = displayCases[currentCase];
  const isSingleImage = currentCaseData.before_url === currentCaseData.after_url;
          ...
          <div className="max-w-3xl mx-auto">
            ...
            {isSingleImage ? (
              <div className="relative rounded-2xl overflow-hidden shadow-elevated border border-ink/5 aspect-[4/3]">
                <Image
                  src={currentCaseData.before_url}
                  alt={currentCaseData.title || "Imagen del tratamiento"}
                  fill
